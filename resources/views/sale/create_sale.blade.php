...
@section('content')
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="{{ route('dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ route('sale') }}" class="tip-bottom">Sales</a> <a href="#" class="current">Create Sale</a> </div>
            @if(count($errors) > 0)
                ...
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="{{ route('sale.post.create') }}" method="post" class="form-horizontal">
                                {{ csrf_field() }}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="remark" id="remark" class="span10" placeholder="Enter Remark" value="{{ Request::old('remark') }}"/>
                                    </div>
                                </div>
                                <div class="control-group">
